...
const index_1 = __webpack_require__(/*! @solver/index */ "../source/index.ts");
exports.solver = index_1.Solver;


/***/ }),

/***/ "../node_modules/wordler-core/data/official.ts":
/*!*****************************************************!*\
  !*** ../node_modules/wordler-core/data/official.ts ***!
  \*****************************************************/
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.OFFICIAL_WORDS = void 0;
exports.OFFICIAL_WORDS = Object.freeze([
    'aahed',
    'aalii',
    'aargh',
    'aarti',
...
/***/ "../node_modules/wordler-core/wordle.ts":
/*!**********************************************!*\
  !*** ../node_modules/wordler-core/wordle.ts ***!
  \**********************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
const official_1 = __webpack_require__(/*! ./data/official */ "../node_modules/wordler-core/data/official.ts");
var PLACEMENT;
(function (PLACEMENT) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const wordle_1 = __webpack_require__(/*! wordler-core/wordle */ "../node_modules/wordler-core/wordle.ts");
const official_1 = __webpack_require__(/*! wordler-core/data/official */ "../node_modules/wordler-core/data/official.ts");
const solver_1 = __webpack_require__(/*! ./customizable/solver */ "./source/customizable/solver.ts");
let wordle;
const getWordleFromGameState = (gameState) => {
    const wordle = new wordle_1.Wordle(gameState.solution, {
        allowedGuesses: official_1.OFFICIAL_WORDS,
    });
...
chrome.runtime.onMessage.addListener(function (request, sender, sendResponse_) {
    ...
    const handleGuess = ({ gameState }) => {
        ...
        const recommendations = solver_1.solver.getTopRecommendations(wordle);
        sendResponse({
            status: 'success',
            recommendations,
            wordle,
